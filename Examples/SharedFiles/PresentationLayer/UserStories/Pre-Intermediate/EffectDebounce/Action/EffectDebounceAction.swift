...
// MARK: - EffectDebounceAction

/// All available `EffectDebounce` module actions.
///
/// It's a type that represents all of the actions that can happen in `EffectDebounce` feature,
