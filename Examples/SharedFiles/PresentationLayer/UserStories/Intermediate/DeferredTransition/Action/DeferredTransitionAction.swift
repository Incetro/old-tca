//
//  DeferredTransitionAction.swift
//  verse-examples
//
...
// MARK: - DeferredTransitionAction

/// All available `DeferredTransition` module actions.
///
/// It's a type that represents all of the actions that can happen in `DeferredTransition` feature,
...
public enum DeferredTransitionAction: Equatable {
