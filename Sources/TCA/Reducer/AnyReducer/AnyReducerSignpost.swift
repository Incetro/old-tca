...
extension AnyReducer {
  ...
  @available(
    ...
    message:
      """
      This API has been soft-deprecated in favor of 'ReducerProtocol.signpost'. Read the migration guide for more information: https://pointfreeco.github.io/swift-tca/main/documentation/composablearchitecture/reducerprotocol
      """
  )
  @available(
    macOS,
