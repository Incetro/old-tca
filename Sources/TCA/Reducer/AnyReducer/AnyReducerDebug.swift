...
extension AnyReducer {
  ...
  @available(
    ...
    message:
      """
      This API has been soft-deprecated in favor of 'ReducerProtocol.debug'. Read the migration guide for more information: https://pointfreeco.github.io/swift-tca/main/documentation/composablearchitecture/reducerprotocol
      """
  )
  @available(
    macOS,
...
@available(
  ...
  message:
    """
    This API that used this type has been soft-deprecated in favor of 'ReducerProtocol.debug'. Read the migration guide for more information: https://pointfreeco.github.io/swift-tca/main/documentation/composablearchitecture/reducerprotocol
    """
)
@available(
  macOS,
...
private let _queue = DispatchQueue(
  label: "co.pointfree.TCA.DebugEnvironment",
  qos: .default
)
