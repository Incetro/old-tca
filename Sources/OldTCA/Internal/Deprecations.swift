...
@available(
    *,
    ...
    See the migration guide for more information: https://pointfreeco.github.io/swift-tca/main/documentation/composablearchitecture/reducerprotocol
    """
)
...
extension WithViewStore: AccessibilityRotorContent where Content: AccessibilityRotorContent {
    ...
    @available(
      ...
      See the documentation for "WithViewStore" (https://pointfreeco.github.io/swift-tca/main/documentation/composablearchitecture/viewstore#overview) for more information.
      """
    )
    public init(
...
@available(
    *, deprecated,
    ...
    https://github.com/pointfreeco/swift-tca/discussions/new
    """
)
extension Store {
...
extension EffectPublisher {
    @available(
      ...
      on this change, see: https://github.com/pointfreeco/swift-tca/pull/1041
      """
    )
    @_disfavoredOverload
...
extension AnyReducer {
    ...
    public func forEach<GlobalState, GlobalAction, GlobalEnvironment, ID>(
        ...
        self.forEach(
            ...
            environment: { _ in localEnvironment() },
            file: file,
            line: line
        )
    }
...
extension ViewStore where ViewAction: BindableAction, ViewAction.State == ViewState {
    @available(
      ...
      https://github.com/pointfreeco/swift-tca/pull/810
      """
    )
    @MainActor
