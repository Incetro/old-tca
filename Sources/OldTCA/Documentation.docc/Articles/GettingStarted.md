...
Package.swift and specify the `TCA` product in any targets that need access to 
the library:
...
let package = Package(
  dependencies: [
    .package(
      url: "https://github.com/pointfreeco/swift-tca",
      from: "0.42.0"
    ),
  ],
  targets: [
...
[examples]: https://github.com/pointfreeco/swift-tca/tree/main/Examples
